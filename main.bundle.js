...
var AppServices = (function () {
    ...
    AppServices.prototype.logIn = function (user) {
        var header = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["a" /* Headers */]();
        header.append('Content-Type', 'application/json');
        return this.http.post('http://localhost:3000/api/user/sign_in', user, { headers: header })
            .map(function (res) { return res.json(); });
    };
    AppServices.prototype.authenticateUser = function () {
        ...
        return this.http.get('http://localhost:3000/api/user/authenticate', { headers: headers })
            .map(function (res) { return res.json(); });
    };
