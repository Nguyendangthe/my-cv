...
module.exports = "<div class=\"root_div container-fluid\" [ngStyle]=\"{'background-image': 'url(./assets/img/edu.jpg)'}\">\n  <div class=\"contain_div\" >\n      <h1>Education </h1>\n   \n          <div *ngFor=\"let edu of education\">           \n              <h3><span class=\"title\">Collage : </span>{{edu.SchoolName}}</h3>\n              <h3><span class=\"title\">Time : </span>From {{edu.StartWhen}} to {{edu.EndWhen}}</h3>\n              <h3><span class=\"title\">Major : </span>{{edu.Major}}</h3>\n              <h3><span class=\"title\">Graduation year : </span>{{edu.GraduationYear}}</h3>\n              <h3><span class=\"title\">GPA :</span>{{edu.AverageScore}}</h3>\n          </div>\n \n    \n          \n  </div>\n</div>"
